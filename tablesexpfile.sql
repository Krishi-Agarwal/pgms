...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Apr 13, 2023 at 06:01 PM
...
INSERT INTO `feedback` (`FID`, `SID`, `COMMENT`, `DOC`) VALUES
(2, 3, 'THANK YOU FOR MERCY', '2023-03-27'),
(3, 2, 'FOOD WAS AWESOME', '2023-03-28'),
(4, 1, 'food is good', '2023-03-31');
...
INSERT INTO `student` (`SID`, `NAME`, `PHONE_NUMBER`, `GENDER`, `RNO`, `UNO`, `RENT`, `username`, `password`) VALUES
(1, 'CHERRY RAMPURIA', '9083223155', 'FEMALE', 1, 1, 150000, '', ''),
(2, 'KHUSHI MITTAL', '64984848484', 'FEMALE', 2, 2, 150000, '', ''),
(3, 'VISHAL JINDAL', '654848484', 'others', 2, 2, 1, '', '');
...
--
ALTER TABLE `login_stats`
  MODIFY `loginno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
